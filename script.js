// 1. Create Onclick function with If/Else statements.//

//2. If image is selected. Flip/remove photo and display text of image.//

//3. Create #id tags for each img on holds.html. Then associate those Ids in order to build the if/else statements. So that the function can understand when each image is clicked it will perform a different action.//

//4. Refer to: w3schools.com/howto/howto_css_flip_image.asp
